...
const patchBooking = (id, bookingData) => __awaiter(void 0, void 0, void 0, function* () {
    return yield BookingModel_1.Booking.findByIdAndUpdate(id, bookingData, { new: true, runValidators: true });
});
exports.patchBooking = patchBooking;
const deleteBooking = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield BookingModel_1.Booking.findByIdAndDelete(id).lean();
});
